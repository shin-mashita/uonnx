...
static int Sum_exit(Node * n)
{
	return 1;
}

static int Sum_reshape(Node * n)
{
...
static void Sum_bfloat16(Node * n)
{
	Tensor * y = n->outputs[0];
	Tensor * x;
...
static void Sum_float16(Node * n)
{
	Tensor * y = n->outputs[0];
	Tensor * x;
	uint16_t * py = (uint16_t *)y->datas;
...
static void Sum_float32(Node * n)
{
	Tensor * y = n->outputs[0];
	Tensor * x;
...
static void Sum_float64(Node * n)
{
	Tensor * y = n->outputs[0];
	Tensor * x;
