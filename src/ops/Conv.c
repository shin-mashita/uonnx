...
static int Conv_reshape(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
...
static void Conv_float16(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
	Tensor * y = n->outputs[0];
	Tensor * x = n->inputs[0];
...
static void Conv_float32(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
	Tensor * y = n->outputs[0];
	Tensor * x = n->inputs[0];
...
static void Conv_float64(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
	Tensor * y = n->outputs[0];
	Tensor * x = n->inputs[0];
