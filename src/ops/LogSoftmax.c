...
static int LogSoftmax_13_init(Node * n)
{
...
static int LogSoftmax_13_exit(Node * n)
{
...
static int LogSoftmax_13_reshape(Node * n)
{
	struct operator_13_pdata_t * pdat = (struct operator_13_pdata_t *)n->priv;
	Tensor * x = n->inputs[0];
...
static void LogSoftmax_13_bfloat16(Node * n)
{
	struct operator_13_pdata_t * pdat = (struct operator_13_pdata_t *)n->priv;
	Tensor * x = n->inputs[0];
	Tensor * y = n->outputs[0];
...
static void LogSoftmax_13_float16(Node * n)
{
	struct operator_13_pdata_t * pdat = (struct operator_13_pdata_t *)n->priv;
	Tensor * x = n->inputs[0];
	Tensor * y = n->outputs[0];
...
static void LogSoftmax_13_float32(Node * n)
{
	struct operator_13_pdata_t * pdat = (struct operator_13_pdata_t *)n->priv;
	Tensor * x = n->inputs[0];
	Tensor * y = n->outputs[0];
...
static void LogSoftmax_13_float64(Node * n)
{
	struct operator_13_pdata_t * pdat = (struct operator_13_pdata_t *)n->priv;
	Tensor * x = n->inputs[0];
	Tensor * y = n->outputs[0];
...
static int LogSoftmax_1_11_init(Node * n)
{
...
static int LogSoftmax_1_11_exit(Node * n)
{
...
static int LogSoftmax_1_11_reshape(Node * n)
{
	struct operator_1_11_pdata_t * pdat = (struct operator_1_11_pdata_t *)n->priv;
	Tensor * x = n->inputs[0];
	Tensor * y = n->outputs[0];
...
static void LogSoftmax_1_11_float16(Node * n)
{
	struct operator_1_11_pdata_t * pdat = (struct operator_1_11_pdata_t *)n->priv;
	Tensor * x = n->inputs[0];
	Tensor * y = n->outputs[0];
...
static void LogSoftmax_1_11_float32(Node * n)
{
	struct operator_1_11_pdata_t * pdat = (struct operator_1_11_pdata_t *)n->priv;
	Tensor * x = n->inputs[0];
	Tensor * y = n->outputs[0];
...
static void LogSoftmax_1_11_float64(Node * n)
{
	struct operator_1_11_pdata_t * pdat = (struct operator_1_11_pdata_t *)n->priv;
	Tensor * x = n->inputs[0];
	Tensor * y = n->outputs[0];
