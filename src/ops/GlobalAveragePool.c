...
static int GlobalAveragePool_init(Node * n)
{
...
static int GlobalAveragePool_exit(Node * n)
{
	return 1;
}

static int GlobalAveragePool_reshape(Node * n)
{
	Tensor * x = n->inputs[0];
...
static void GlobalAveragePool_float16(Node * n)
{
	Tensor * x = n->inputs[0];
	Tensor * y = n->outputs[0];
...
static void GlobalAveragePool_float32(Node * n)
{
	Tensor * x = n->inputs[0];
	Tensor * y = n->outputs[0];
...
static void GlobalAveragePool_float64(Node * n)
{
	Tensor * x = n->inputs[0];
	Tensor * y = n->outputs[0];
