...
static int MatMul_reshape(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
...
static void MatMul_int32(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
	Tensor * y = n->outputs[0];
	Tensor * a = n->inputs[0];
...
static void MatMul_int64(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
	Tensor * y = n->outputs[0];
	Tensor * a = n->inputs[0];
...
static void MatMul_uint32(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
	Tensor * y = n->outputs[0];
	Tensor * a = n->inputs[0];
...
static void MatMul_uint64(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
	Tensor * y = n->outputs[0];
	Tensor * a = n->inputs[0];
...
static void MatMul_bfloat16(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
	Tensor * y = n->outputs[0];
	Tensor * a = n->inputs[0];
...
static void MatMul_float16(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
	Tensor * y = n->outputs[0];
	Tensor * a = n->inputs[0];
...
static void MatMul_float32(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
	Tensor * y = n->outputs[0];
	Tensor * a = n->inputs[0];
...
static void MatMul_float64(Node * n)
{
	struct operator_pdata_t * pdat = (struct operator_pdata_t *)n->priv;
	Tensor * y = n->outputs[0];
	Tensor * a = n->inputs[0];
