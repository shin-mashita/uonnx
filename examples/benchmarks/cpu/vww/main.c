...
int main()
{
    const char * labels[2] = {"no person", "person"};
    float output[2];
    ...
    ctx = uonnx_init(vww_float32_9_onnx, sizeof(vww_float32_9_onnx), vww_float32_9_planner, sizeof(vww_float32_9_planner));
    ...
    model = load_model_buf(vww_float32_9_onnx, sizeof(vww_float32_9_onnx));
    mem1 = get_current_mem();
    planner = load_planner_buf(vww_float32_9_planner, sizeof(vww_float32_9_planner));
