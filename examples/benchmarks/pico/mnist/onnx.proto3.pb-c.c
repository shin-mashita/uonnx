...
size_t onnx__attribute_proto__get_packed_size(const Onnx__AttributeProto *message)
{
...
size_t onnx__attribute_proto__pack_to_buffer(const Onnx__AttributeProto *message,
...
onnx__attribute_proto__unpack(ProtobufCAllocator *allocator,
                              size_t len,
                              const uint8_t *data)
{
...
size_t onnx__value_info_proto__get_packed_size(const Onnx__ValueInfoProto *message)
{
...
size_t onnx__value_info_proto__pack_to_buffer(const Onnx__ValueInfoProto *message,
                                              ProtobufCBuffer *buffer)
{
  assert(message->base.descriptor == &onnx__value_info_proto__descriptor);
  return protobuf_c_message_pack_to_buffer((const ProtobufCMessage *)message, buffer);
...
onnx__value_info_proto__unpack(ProtobufCAllocator *allocator,
                               size_t len,
                               const uint8_t *data)
{
...
size_t onnx__node_proto__pack(const Onnx__NodeProto *message,
                              uint8_t *out)
{
  assert(message->base.descriptor == &onnx__node_proto__descriptor);
  return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
...
Onnx__NodeProto *
onnx__node_proto__unpack(ProtobufCAllocator *allocator,
                         size_t len,
                         const uint8_t *data)
{
...
size_t onnx__training_info_proto__get_packed_size(const Onnx__TrainingInfoProto *message)
{
...
size_t onnx__training_info_proto__pack_to_buffer(const Onnx__TrainingInfoProto *message,
                                                 ProtobufCBuffer *buffer)
{
  assert(message->base.descriptor == &onnx__training_info_proto__descriptor);
  return protobuf_c_message_pack_to_buffer((const ProtobufCMessage *)message, buffer);
...
onnx__training_info_proto__unpack(ProtobufCAllocator *allocator,
                                  size_t len,
                                  const uint8_t *data)
{
...
size_t onnx__model_proto__pack(const Onnx__ModelProto *message,
                               uint8_t *out)
{
  assert(message->base.descriptor == &onnx__model_proto__descriptor);
  return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
...
Onnx__ModelProto *
onnx__model_proto__unpack(ProtobufCAllocator *allocator,
                          size_t len,
                          const uint8_t *data)
{
...
void onnx__string_string_entry_proto__init(Onnx__StringStringEntryProto *message)
{
  static const Onnx__StringStringEntryProto init_value = ONNX__STRING_STRING_ENTRY_PROTO__INIT;
  *message = init_value;
}
size_t onnx__string_string_entry_proto__get_packed_size(const Onnx__StringStringEntryProto *message)
{
  assert(message->base.descriptor == &onnx__string_string_entry_proto__descriptor);
  return protobuf_c_message_get_packed_size((const ProtobufCMessage *)(message));
}
size_t onnx__string_string_entry_proto__pack(const Onnx__StringStringEntryProto *message,
                                             uint8_t *out)
{
  assert(message->base.descriptor == &onnx__string_string_entry_proto__descriptor);
  return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
}
size_t onnx__string_string_entry_proto__pack_to_buffer(const Onnx__StringStringEntryProto *message,
                                                       ProtobufCBuffer *buffer)
{
  assert(message->base.descriptor == &onnx__string_string_entry_proto__descriptor);
  return protobuf_c_message_pack_to_buffer((const ProtobufCMessage *)message, buffer);
...
void onnx__string_string_entry_proto__free_unpacked(Onnx__StringStringEntryProto *message,
                                                    ProtobufCAllocator *allocator)
{
  if (!message)
    return;
...
size_t onnx__tensor_annotation__get_packed_size(const Onnx__TensorAnnotation *message)
{
...
size_t onnx__tensor_annotation__pack_to_buffer(const Onnx__TensorAnnotation *message,
                                               ProtobufCBuffer *buffer)
{
  assert(message->base.descriptor == &onnx__tensor_annotation__descriptor);
  return protobuf_c_message_pack_to_buffer((const ProtobufCMessage *)message, buffer);
...
onnx__tensor_annotation__unpack(ProtobufCAllocator *allocator,
                                size_t len,
                                const uint8_t *data)
{
...
size_t onnx__graph_proto__pack(const Onnx__GraphProto *message,
                               uint8_t *out)
{
  assert(message->base.descriptor == &onnx__graph_proto__descriptor);
  return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
...
Onnx__GraphProto *
onnx__graph_proto__unpack(ProtobufCAllocator *allocator,
                          size_t len,
                          const uint8_t *data)
{
...
Onnx__TensorProto *
onnx__tensor_proto__unpack(ProtobufCAllocator *allocator,
                           size_t len,
                           const uint8_t *data)
{
...
size_t onnx__sparse_tensor_proto__get_packed_size(const Onnx__SparseTensorProto *message)
{
...
size_t onnx__sparse_tensor_proto__pack_to_buffer(const Onnx__SparseTensorProto *message,
                                                 ProtobufCBuffer *buffer)
{
  assert(message->base.descriptor == &onnx__sparse_tensor_proto__descriptor);
  return protobuf_c_message_pack_to_buffer((const ProtobufCMessage *)message, buffer);
...
onnx__sparse_tensor_proto__unpack(ProtobufCAllocator *allocator,
                                  size_t len,
                                  const uint8_t *data)
{
...
void onnx__tensor_shape_proto__dimension__init(Onnx__TensorShapeProto__Dimension *message)
{
...
size_t onnx__tensor_shape_proto__get_packed_size(const Onnx__TensorShapeProto *message)
{
...
size_t onnx__tensor_shape_proto__pack_to_buffer(const Onnx__TensorShapeProto *message,
                                                ProtobufCBuffer *buffer)
{
  assert(message->base.descriptor == &onnx__tensor_shape_proto__descriptor);
  return protobuf_c_message_pack_to_buffer((const ProtobufCMessage *)message, buffer);
...
onnx__tensor_shape_proto__unpack(ProtobufCAllocator *allocator,
                                 size_t len,
                                 const uint8_t *data)
{
...
void onnx__type_proto__optional__init(Onnx__TypeProto__Optional *message)
{
  static const Onnx__TypeProto__Optional init_value = ONNX__TYPE_PROTO__OPTIONAL__INIT;
  *message = init_value;
}
void onnx__type_proto__sparse_tensor__init(Onnx__TypeProto__SparseTensor *message)
{
...
size_t onnx__type_proto__pack(const Onnx__TypeProto *message,
                              uint8_t *out)
{
  assert(message->base.descriptor == &onnx__type_proto__descriptor);
  return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
...
Onnx__TypeProto *
onnx__type_proto__unpack(ProtobufCAllocator *allocator,
                         size_t len,
                         const uint8_t *data)
{
...
size_t onnx__operator_set_id_proto__get_packed_size(const Onnx__OperatorSetIdProto *message)
{
  assert(message->base.descriptor == &onnx__operator_set_id_proto__descriptor);
  return protobuf_c_message_get_packed_size((const ProtobufCMessage *)(message));
}
size_t onnx__operator_set_id_proto__pack(const Onnx__OperatorSetIdProto *message,
                                         uint8_t *out)
{
  assert(message->base.descriptor == &onnx__operator_set_id_proto__descriptor);
  return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
}
size_t onnx__operator_set_id_proto__pack_to_buffer(const Onnx__OperatorSetIdProto *message,
                                                   ProtobufCBuffer *buffer)
{
  assert(message->base.descriptor == &onnx__operator_set_id_proto__descriptor);
  return protobuf_c_message_pack_to_buffer((const ProtobufCMessage *)message, buffer);
...
onnx__operator_set_id_proto__unpack(ProtobufCAllocator *allocator,
                                    size_t len,
                                    const uint8_t *data)
{
...
void onnx__operator_set_id_proto__free_unpacked(Onnx__OperatorSetIdProto *message,
                                                ProtobufCAllocator *allocator)
{
  if (!message)
    return;
...
void onnx__function_proto__init(Onnx__FunctionProto *message)
{
  static const Onnx__FunctionProto init_value = ONNX__FUNCTION_PROTO__INIT;
  *message = init_value;
}
size_t onnx__function_proto__get_packed_size(const Onnx__FunctionProto *message)
{
  assert(message->base.descriptor == &onnx__function_proto__descriptor);
  return protobuf_c_message_get_packed_size((const ProtobufCMessage *)(message));
}
size_t onnx__function_proto__pack(const Onnx__FunctionProto *message,
                                  uint8_t *out)
{
  assert(message->base.descriptor == &onnx__function_proto__descriptor);
  return protobuf_c_message_pack((const ProtobufCMessage *)message, out);
}
size_t onnx__function_proto__pack_to_buffer(const Onnx__FunctionProto *message,
                                            ProtobufCBuffer *buffer)
{
  assert(message->base.descriptor == &onnx__function_proto__descriptor);
  return protobuf_c_message_pack_to_buffer((const ProtobufCMessage *)message, buffer);
...
Onnx__FunctionProto *
onnx__function_proto__unpack(ProtobufCAllocator *allocator,
                             size_t len,
                             const uint8_t *data)
{
...
void onnx__function_proto__free_unpacked(Onnx__FunctionProto *message,
                                         ProtobufCAllocator *allocator)
{
  if (!message)
    return;
